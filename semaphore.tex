...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} semaphore}\moduleRightDash\cl{}
\fl{}
\fl{ {\VARIABLE} color}
\fl{}
\fl{ TypeOK \.{\defeq} color \.{\in} (\@w{red} ,\,\@w{green} ,\,\@w{yellow} )}
\fl{}
\fl{}
\fl{ Init \.{\defeq} color \.{=}\@w{red}}
\fl{}
\fl{}
\fl{ TurnGreen \.{\defeq} {\TRUE}}
\fl{ TurnYellow \.{\defeq} {\TRUE}}
\fl{ TurnRed \.{\defeq} {\TRUE}}
\fl{}
\fl{ Next \.{\defeq} TunrGreen \.{\lor} TurnYellow \.{\lor} TurnRed}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
